...
public class InternationalDelegates {

    private String name, designation, organisation, organisationAddress, email, mobile, feedback, signature, photo, date, time;

    public InternationalDelegates(){

    }

    public InternationalDelegates(String name, String designation, String organisation, String organisationAddress,
